...
class Show(db.Model):
    ...
    image_link = db.Column(db.String(500), nullable=False,
                           default='https://images.unsplash.com/photo-1459058537932-d95b3e068690?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80')
...
def venues():
    ...
    areas = Venue.query.with_entities(func.count(
        Venue.id), Venue.city, Venue.state).group_by(Venue.state, Venue.city).all()
    data = []
